...
export default function SignInPage() {
  return (
    <main className="flex h-full w-full flex-1 items-center justify-center font-sans">
      <section className="mx-auto flex max-w-4xl flex-col overflow-hidden rounded-lg bg-white shadow-lg dark:bg-gray-800 md:h-[24rem] md:flex-row">
        ...
        <div className="text- flex items-center justify-center pb-6 md:w-1/2 md:py-0">
          <SignInForm />
        </div>
      </section>
    </main>
